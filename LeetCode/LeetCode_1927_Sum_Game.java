...
public class LeetCode_1927_Sum_Game {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sumGame(num) ? "Alice" : "Bob");
    }
    ...
    static boolean sumGame(String num) {
        ...
        if ((totalCount & 1) == 1) return true;

        int LEFT = (lSum << 1) + lCount * 9;
        int RIGHT = (rSum << 1) + rCount * 9;
        return LEFT != RIGHT;
    }
}
